...
class Pig(Mob):
    ...
    def _build_vao(self):
        ...
        body_hw, body_hh, body_hl = 0.50, 0.35, 0.65
        body_cy = 0.62
        leg_w, leg_h = 0.16, 0.50
    ...
    def update(self):
        ...
        if random.random() < 0.25:
            self.move(math.cos(self.yaw) * PIG_SPEED * dt,
                      math.sin(self.yaw) * PIG_SPEED * dt)
    ...
    def render(self):
        ...
        self.vao.render()        v += self._face([x1,y0,z0],[x0,y0,z0],[x0,y1,z0],[x1,y1,z0], back)
        v += self._face([x0,y0,z0],[x0,y0,z1],[x0,y1,z1],[x0,y1,z0], left)
        v += self._face([x1,y0,z1],[x1,y0,z0],[x1,y1,z0],[x1,y1,z1], right)
        v += self._face([x0,y1,z1],[x1,y1,z1],[x1,y1,z0],[x0,y1,z0], top)
        v += self._face([x0,y0,z0],[x1,y0,z0],[x1,y0,z1],[x0,y0,z1], bottom)
